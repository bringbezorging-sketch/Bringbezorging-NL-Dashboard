...
export function detectFraud(o) {
  ...
  // Contant = betaling in behandeling via BringBezorging kanaal
  const isContant = o.financial_status === 'pending' && (o.source_name === 'BringBezorging' || o.app_id);
  if (isContant) { reasons.push('Contant betaald'); score+=3; }
  ...
  return { isFraud: score>=5, reasons, noHouseNr, isContant };
}
